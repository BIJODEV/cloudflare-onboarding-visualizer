...
const STAGES = {
  ...
  proxy: {
    ...
    wafRules: {
      ...
      managed: "600+ Cloudflare Managed Ruleset rules",
      ...
      {/* Security Details Panel - Show only in Proxy state */}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 max-w-4xl w-full mt-4 border-l-4 border-purple-500">
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-red-800 mb-2">Web Application Firewall (779+ Rules)</h4>
                    <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="font-semibold">600+ rules</span>
                    </div>
                    <div className="flex justify-between">
